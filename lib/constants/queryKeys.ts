...
// filters param is `unknown` so any typed filter object is assignable.
...
export const queryKeys = {
  ...
  shops: {
    all:    ()                          => ["shops"] as const,
    list:   (filters?: unknown)         => ["shops", "list", filters] as const,
  ...
  billing: {
    ...
    usage:    (filters?: unknown) => ["billing", "usage", filters] as const,
  ...
  products: {
    ...
    list:     (shopId: string, filters?: unknown) => ["products", shopId, "list", filters] as const,
  ...
  orders: {
    ...
    list:   (shopId: string, filters?: unknown) => ["orders", shopId, "list", filters] as const,
  ...
  customers: {
    ...
    list:   (shopId: string, filters?: unknown) => ["customers", shopId, "list", filters] as const,
  ...
  inventory: {
    ...
    movements: (shopId: string, filters?: unknown) => ["inventory", shopId, "movements", filters] as const,
  },

  // ── Reports (shop-scoped) ─────────────────────────────────────────────────
  reports: {
    sales:        (shopId: string, filters?: unknown) => ["reports", shopId, "sales", filters] as const,
    topProducts:  (shopId: string, filters?: unknown) => ["reports", shopId, "topProducts", filters] as const,
    topCustomers: (shopId: string, filters?: unknown) => ["reports", shopId, "topCustomers", filters] as const,
  },
} as const;
